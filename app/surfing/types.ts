...
export const surfBoards: SurfItem[] = [
  {
    id: 1,
    price: 20,
...
export const surfingEquipment: Surfing[] = [{
  surfboards: [
    {
      id: 1,
      price: 20,
